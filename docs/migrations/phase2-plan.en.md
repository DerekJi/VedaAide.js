...
- [ ] Install Ollama/OpenAI connectors
...
- [ ] PDF loader (optional)
- [ ] Unified `Document` object conversion
...
```
- [ ] Recursive splitter integration
- [ ] Markdown splitter
...
```
- [ ] Dual-layer check logic
- [ ] Skip statistics recording
...
```
- [ ] Build ReAct Agent using LangGraph
- [ ] Tool calling loop
- [ ] Intermediate step tracing
...
- [ ] Return intermediate step trace
...
- [ ] VS Code Copilot call tests
- [ ] Log verification of tool calls
...
- [ ] Prisma `SyncedFile` table updates
...
- [ ] Manual trigger API: `POST /api/datasources/sync`
- [ ] Logging
...
## ✅ Task Checklist
- [ ] T1-T5: LangChain RAG chain
- [ ] T6-T8: Dual-layer dedup
- [ ] T9-T11: Dual-layer hallucination detection
- [ ] T12-T14: Agent orchestration
- [ ] T15-T17: MCP Server
- [ ] T18-T20: MCP Client
- [ ] T21-T22: Prompt management
