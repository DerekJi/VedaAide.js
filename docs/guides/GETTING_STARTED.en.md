...
- [Quick Start](QUICK_START.en.md) — fast path for developers who know the stack
- [Testing Guide](../testing/TESTING.en.md) — unit, integration, and E2E tests
- [Deployment Guide](../reference/DEPLOYMENT.en.md) — cloud deployment on Azure
